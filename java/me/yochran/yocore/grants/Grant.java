...
public class Grant {
    ...
    public void setStatus(String status) {
        this.status = status;
        plugin.grantData.config.set(getTarget().getUniqueId().toString() + ".Grants." + getID() + ".Status", status);
    }
    ...
    public void create() {
        plugin.grantData.config.set(getTarget().getUniqueId().toString() + ".GrantsAmount", getID());
