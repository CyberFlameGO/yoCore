...
public class ReBanCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        punishmentManagement.redoInfraction("Ban", punishmentManagement.getInfractionAmount(target, "Ban"), target, executor, reason, System.currentTimeMillis(), "Permanent", silent);
        punishmentManagement.redoBan(target, false);
